...
./src/scripts/train_multi_agent_reward.sh 2>&1 | tee train_multi_agent_reward2.log
...
./src/scripts/train_multi_agent_score.sh 2>&1 | tee train_multi_agent_score2.log
