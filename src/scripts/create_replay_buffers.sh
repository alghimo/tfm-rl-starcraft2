...
TRAIN_MINERALS_EPISODES=100
TRAIN_MARINES_EPISODES=50
TRAIN_ATTACK_EPISODES=400
TRAIN_SIMPLE64_EPISODES=50
...
python runner.py --agent_key "${AGENT_KEY}" --map_name "CollectMineralsAndGas" --num_episodes ${TRAIN_MINERALS_EPISODES} --log_file ${MODEL_DIR_COLLECT_MINERALS}/training${LOG_SUFFIX}.log --model_id ${MODEL_ID_COLLECT_MINERALS} --models_path ${MODELS_DIR} --reward_method ${REWARD_METHOD} 2>&1 | tee ${MODEL_DIR_COLLECT_MINERALS}/CollectMineralsAndGas${LOG_SUFFIX}.log
