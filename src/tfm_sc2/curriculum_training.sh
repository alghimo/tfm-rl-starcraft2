...
LOG_SUFFIX="_01"
mkdir -p ${LOG_DIR} ${LOG_DIR_RANDOM} ${LOG_DIR_COLLECT_MINERALS} ${LOG_DIR_BUILD_MARINES} ${LOG_DIR_DEFEAT_ROACHES} ${LOG_DIR_SIMPLE64}
# BURNIN_EPISODES=10
# TRAIN_EPISODES=100
# TRAIN_EPISODES_SIMPLE64=50
# EXPLOIT_EPISODES=5
# EXPLOIT_EPISODES_SIMPLE64=10
BURNIN_EPISODES=5
TRAIN_EPISODES=50
TRAIN_EPISODES_SIMPLE64=25
EXPLOIT_EPISODES=25
EXPLOIT_EPISODES_SIMPLE64=15
